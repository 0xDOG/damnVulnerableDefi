...
describe('[Challenge] Backdoor', function () {
  ...
  it('Exploit', async function () {
    ...
    // console.log('this.walletFactory.address', this.walletFactory.address)
    console.log('this.walletRegistry.address', this.walletRegistry.address)

    await exploit.execute()

    // console.log(await this.token.allowance(users[0], exploit.address))
    // users.forEach(async (user) =>
    //   console.log(await this.walletRegistry.wallets(user))
    // )
  })
